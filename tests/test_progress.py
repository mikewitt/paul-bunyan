...
# --- the session heartbeat: is anything arriving at all? --------------------
#
...
# time, because a frame that turns while the stream says nothing is claiming
...
def test_the_heartbeat_survives_a_rich_free_install(store, make_row, monkeypatch):
    ...
    rather than merely called, so a `from rich...` added at the top of the
    module later fails here too."""
